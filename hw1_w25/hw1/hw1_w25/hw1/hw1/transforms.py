...
class InvertColors(object):
    ...
    def __call__(self, x: torch.Tensor):
        ...
        # Invert the colors by subtracting the tensor from 1
        return 1 - x
        # ========================
...
class FlipUpDown(object):
    def __call__(self, x: torch.Tensor):
        ...
        # Flip the tensor along the height dimension (axis 1)
...
class BiasTrick(object):
    ...
    def __call__(self, x: torch.Tensor):
        ...
        # Concatenate the ones tensor with the input tensor along the last dimension
